...
import { AppointmentsBrowser } from "./appointments-browser";
import { AppointmentsTWA } from "./appointments-twa";
      ...
      <div className="bg-background flex min-h-screen items-center justify-center p-4">
        <Card className="w-full max-w-md p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Silakan masuk atau daftar untuk melihat dan mengelola jadwal konsultasi Anda
          </p>
